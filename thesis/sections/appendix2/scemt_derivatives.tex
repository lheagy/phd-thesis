...
For the sensitivity calculation, we require the derivative of $\sigma^*$ with respect to the concentration $\phi$. We will solve for it implicitly. Starting from equation \ref{eq:emt_mapping}, we have
\begin{displaymath}
\begin{split}
    - (\sigma^* - \sigma_0)& R^{(0,*)}
